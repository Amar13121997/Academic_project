  ...
  <div id="container"> 
    <div id="header"> 
      <div id="logo"><br>
        ...
        Detection of Fraudulent Sellers in Online Marketplaces  <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            ...
            <td width="410" bgcolor="#FBF7E1"> <fieldset>
              ...
              <form name="f" action="re_pro_insert.jsp" method="post" onsubmit="return valid()">
                <table cellpadding="10" cellspacing="10">
                  ...
                  <tr> 
                    <td align="center"><font color="#333366" size="+1" face="Georgia, Times New Roman, Times, serif"><strong>Warrenty Days:</strong></font></td>
